...
def get_rotation (sub):
    ...
    translation_vector2 = (0.52, 0, 0.53)    #qy, -qx, 0 
    ...
    odom_right2 = Odometry()
    odom_right2.header.stamp = current_time
    odom_right2.header.frame_id = "odom_right2"
    odom_right2.child_frame_id = "base_link" 


    odom_publisher.publish(odom_right)
    odom_publisher2.publish(odom_right2)


if __name__ == '__main__':
     
    rospy.init_node('odom_4', anonymous=True)                             # Node initiation. Node name: odom_encoder
    odom_broadcaster = tf.TransformBroadcaster() 
    odom_broadcaster2 = tf.TransformBroadcaster()
    odom_publisher = rospy.Publisher("odom_right", Odometry, queue_size=50) 
    odom_publisher2 = rospy.Publisher("odom_right2", Odometry, queue_size=50) 

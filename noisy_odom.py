...
def odom_callback(encoders):
    ...
    encoders.x = encoders.x + encoders.x*(random.normal(loc=0, scale=noise, size=(1)))          #noise generation
    encoders.y = encoders.y + encoders.y*(random.normal(loc=0, scale=noise, size=(1)))
...
if __name__ == '__main__':
    ...
    noise = input("Encoder noise degerini giriniz.")

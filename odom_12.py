...
def get_rotation (sub):
    ...
    #cvrc = sub.pose.coveriance
    #covps = sub.twist.covariance
    ...
    translation_vector2 = (0.55, 0, 0.53)    #qy, -qx, 0 
    ...
    translation_vector = (qy, -qx, 0)    #qy, -qx, 0 
    ...
    odom_right.pose.pose.position.x = qy
    odom_right.pose.pose.position.y = -qx
    odom_right.pose.pose.position.z = 0
    #odom_right.pose.covariance = cvrc
    ...
    #odom_right.twist.twist.angular.x = qavz
    #odom_right.twist.twist.angular.y = -qavx
    #odom_right.twist.twist.angular.z = qavz
    #odom_right.twist.covariance = covps

    #odom_right.pose.pose.orientation.x = rx
    #odom_right.pose.pose.orientation.y = ry
    #odom_right.pose.pose.orientation.z = rz
    #odom_right.pose.pose.orientation.w = rw

    odom_cam = Odometry()
    odom_cam.header.stamp = current_time
    odom_cam.header.frame_id = "odom_cam"
    odom_cam.child_frame_id = "base_link" 
    #odom.pose.covariance = cvrc
    #odom.twist.covariance = covps

    odom_publisher.publish(odom_right)
    odom_publisher2.publish(odom_cam)
...
if __name__ == '__main__':
    ...
    odom_publisher2 = rospy.Publisher("odom_cam", Odometry, queue_size=50) 

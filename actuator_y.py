...
instrument = minimalmodbus.Instrument("/dev/ttyUSB3", servo_x_addr2) 
instrument1 = minimalmodbus.Instrument("/dev/ttyUSB4", servo_x_addr1) 
...
#print("Servo ON : "+str(son_read))   #                                  DEC: 101 NORMALLY CLOSED 
...
#print("SPD0 : "+str(spd0_read))                                       #DEC: 114 - NORMALLY CLOSED DEFAULT: 14 NORMALLY OPEN
...
print("SPD1 : "+str(spd1_read))                                         #DEC: 115 NORMALLY CLOSED 
